<xsl:stylesheet xmlns="http://www.tei-c.org/ns/1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:tei="http://www.tei-c.org/ns/1.0" version="2.0">
   ...
   <xsl:template match="tei:choice|tei:restore|tei:space|tei:head|tei:note|tei:pc|tei:metamark|tei:milestone|tei:lb|tei:add|tei:del|tei:subst|tei:hi[not(contains(@spanTo, 'HIERARCHY'))]">
      <xsl:param name="id"/>
